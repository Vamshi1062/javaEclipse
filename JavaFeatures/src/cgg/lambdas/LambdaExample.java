...
//        System.out.println("----------------------------------");
        ...
        Emplist.add(new Employee("def","def@gmail.com",90000.00));
        Emplist.add(new Employee("abc","abc@gmail.com",50000.00));
        Emplist.add(new Employee("pqr","pqr@gmail.com",70000.00));
        Emplist.add(new Employee("lmn","lmn@gmail.com",20000.00));
        System.out.println("List before Sorting");
        for (Employee employee : Emplist) {
			System.out.println(employee);
		}
        System.out.println("---------------------------");
        Collections.sort(Emplist,(e1,e2)->e1.getName().compareTo(e2.getName()));//lambda Expression
        Collections.sort(Emplist,(e1,e2)->(int)(e1.getSalary()-e2.getSalary()));//lambda Expression
        //normal
